...
<header class="header navbar navbar-fixed-top" role="banner">        
    <div class="container">
        ...
        <a class="navbar-brand" href="<?php echo base_url(); ?>"> <img src="<?php echo !empty($this->session->userdata ( 'fb_user_id' )) ? 'https://graph.facebook.com/'.$this->session->userdata ( 'fb_user_id' ).'/picture?height=500&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662' : base_url().'themes/layout/blueone/assets/img/logo.png'; ?>" alt="logo" style="max-height: 40px;" /> <?php echo !empty($this->session->userdata ( 'fb_user_name' )) ? $this->session->userdata ( 'fb_user_name' ) : '<strong>AD</strong>MIN'; ?> </a> <a href="#" class="toggle-sidebar bs-tooltip" data-placement="bottom" data-original-title="Toggle navigation"> <i class="icon-reorder"></i> </a>
        ...
        <ul class="nav navbar-nav navbar-left hidden-xs hidden-sm" style="display:none;">
        ...
        <ul class="nav navbar-nav">
            <li class="dropdown user"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-th-large"></i> <span class="username">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url();?>wordpress/post"><i class="icon-th-list"></i> Post WP</a></li>
                    <li><a href="<?php echo base_url();?>managecampaigns/autopostfb?action=posttoblog&pia=none"><i class="icon-th-list"></i> Post to IA (auto)</a></li>
                    ...
                    <li><a href="<?php echo base_url();?>managecampaigns/autopost"><i class="icon-wrench"></i> Auto Config</a></li>
                </ul>
            </li>            
        </ul>
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown user"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-male"></i> <span class="username">
                ...
                <ul class="dropdown-menu">
                    <li> <a href="<?php echo base_url(); ?>managecampaigns/account"><i class="icon-key"></i> <?php echo !empty($this->session->userdata ( 'fb_user_name' )) ? $this->session->userdata ( 'fb_user_name' ) : 'Not login yet'; ?> <?php echo $this->session->userdata ( 'user_id' ) . ' - '. $this->session->userdata ( 'sid' );?></a> </li>
